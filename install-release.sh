...
# Original source is located at github.com/demonstan/v2ray-poseidon/blob/master/install-release.sh
...
downloadV2Ray(){
    ...
    if [[ "${DIST_SRC}" == "jsdelivr" ]]; then
        ...
        DOWNLOAD_LINK="https://github.com/demonstan/v2ray-poseidon/releases/download/${NEW_VER}/v2ray-linux-${VDIS}.zip"
    fi
...
getVersion(){
    if [[ -n "$VERSION" ]]; then
        ...
        TAG_URL="https://api.github.com/repos/demonstan/v2ray-poseidon/releases/latest"
