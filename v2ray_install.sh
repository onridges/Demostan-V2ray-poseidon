...
CONFIG_FILE="/usr/bin/v2ray/config.json"
...
installV2ray() {
    rm -rf /tmp/v2ray
    mkdir -p /tmp/v2ray
    DOWNLOAD_LINK="${V6_PROXY}https://github.com/demonstan/v2ray-poseidon/releases/download/${NEW_VER}/v2ray-linux-$(archAffix).zip"
